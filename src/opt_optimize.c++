...
//			if (line.find("print(") != std::string::npos || //				line.find("printr(") != std::string::npos ||//				line.find("println(") != std::string::npos ||//				line.find("printrln(") != std::string::npos ||//				line.find("error(") != std::string::npos ||//				line.find("warning(") != std::string::npos ||//				line.find("scientific(") != std::string::npos) {//				if (line.find("void print") == std::string::npos &&//					line.find("string scientific") == std::string::npos &&//					line.find("void error") == std::string::npos && //					line.find("void warning") == std::string::npos) {//					if (filenames[ii] != "simio.c++" && filenames[ii] != "vec.h") {//						line.insert(0, comment);//						line.insert(0, comment);
					}
					out << line;
